...
class BarcodeGenerator:
        ...
        try:
            ...
            for i in range(quantity):
                ...
                if not barcode_data.isdigit():
                    ...
                    print(f"🔄 Código '{barcode_data}' convertido a '{clean_barcode_data}' para EAN13")
    ...
    def _add_text_to_barcode(
        ...
        try:
            ...
            normal_font = ImageFont.truetype(font_path, 22)  # Más grande para texto normal
        ...
        text_y = barcode_height + padding_top + text_spacing  # Comenzar después del código con espacio
    ...
    def _build_text_lines(self, product_info: Dict, print_options: Dict) -> List[str]:
        ...
        if print_options.get('includeCode', True) and product_info.get('barcode'):
            original_barcode = product_info.get('original_barcode', product_info['barcode'])
