...
def main():
    with open("final_test_results.txt", "w") as f:
        ...
        try:
            ...
            cursor.execute(
                "SELECT name FROM sqlite_master WHERE type='table' AND name='proveedorxmarca'"
            )
            ...
            try:
                ...
                if (
                    test_schema
                    and "PRIMARY KEY (id_brand, id_provider)" in test_schema[0]
                ):
            ...
            try:
                ...
                if proveedorxmarca_config:
                    ...
                    if len(foreign_keys) == 2:
                        ...
                        f.write(
                            f"❌ Foreign key configuration issue: {len(foreign_keys)} keys found\n"
                        )
