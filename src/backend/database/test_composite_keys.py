...
def test_composite_primary_keys():
    ...
    if result1["success"] and result2["success"] and result3["success"]:
        ...
        print(f"✗ Failed to add relationships: {result1['message']}, {result2['message']}, {result3['message']}")
        return False
    ...
    if remove_result["success"]:
        ...
        # Verify removal
        exists_after_removal = db.check_provider_brand_relationship_exists(provider1_id, brand1_id)
