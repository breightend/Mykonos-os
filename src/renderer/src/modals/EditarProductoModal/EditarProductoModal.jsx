...
import { X, Save, Calculator, Package, Upload, Camera } from 'lucide-react'
import { inventoryService } from '../../services/inventory/inventoryService'

const EditarProductoModal = ({ isOpen, onClose, productId, onProductUpdated }) => {
            ...
            <div className="space-y-6">
              ...
              {formData.stock_variants && formData.stock_variants.length > 0 && (
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
                  <h3 className="mb-4 text-lg font-semibold text-gray-800">Stock por Variantes</h3>
