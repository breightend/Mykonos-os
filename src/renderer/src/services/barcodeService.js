...
class BarcodeService {
     ...
     * @returns {Promise<Object>} - Objeto con el código de barras SVG
     */
    async generateProductBarcode(productId) {
        try {
            const response = await fetch(`${this.baseUrl}/generate-product/${productId}`)
            ...
            console.error('Error generando código de barras del producto:', error)
            throw error
        }
    }
